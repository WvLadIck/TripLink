...
constexpr auto qt_meta_stringdata_CLASSDriverWindowENDCLASS = QtMocHelpers::stringData(
    "DriverWindow",
...
void DriverWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &DriverWindow::returnToPreviousWindow; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (DriverWindow::*)();
            if (_t _q_method = &DriverWindow::goToCarWindow; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void DriverWindow::goToCarWindow()
{
