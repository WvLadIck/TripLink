...
Q_CONSTINIT const QMetaObject RegistrationWindow::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN18RegistrationWindowE_t,
        ...
        // method 'goToDriverCompanionWindow'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void RegistrationWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_q_method_type _q_method = &RegistrationWindow::returnToMainWindow; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (RegistrationWindow::*)();
            if (_q_method_type _q_method = &RegistrationWindow::goToDriverCompanionWindow; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
