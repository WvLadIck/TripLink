...
static constexpr auto qt_meta_stringdata_ZN12DriverWindowE = QtMocHelpers::stringData(
    "DriverWindow",
...
Q_CONSTINIT static const uint qt_meta_data_ZN12DriverWindowE[] = {
...
Q_CONSTINIT const QMetaObject DriverWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12DriverWindowE.offsetsAndSizes,
    qt_meta_data_ZN12DriverWindowE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12DriverWindowE_t,
        // Q_OBJECT / Q_GADGET
...
void DriverWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (DriverWindow::*)();
            if (_q_method_type _q_method = &DriverWindow::returnToPreviousWindow; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (DriverWindow::*)();
            if (_q_method_type _q_method = &DriverWindow::goToFinishWindow; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
void *DriverWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12DriverWindowE.stringdata0))
