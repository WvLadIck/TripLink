...
static constexpr auto qt_meta_stringdata_ZN11ManagerFormE = QtMocHelpers::stringData(
    "ManagerForm",
    "showLoginWindow",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_ZN11ManagerFormE[] = {
...
Q_CONSTINIT const QMetaObject ManagerForm::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11ManagerFormE.offsetsAndSizes,
    qt_meta_data_ZN11ManagerFormE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11ManagerFormE_t,
        // Q_OBJECT / Q_GADGET
...
void *ManagerForm::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11ManagerFormE.stringdata0))
